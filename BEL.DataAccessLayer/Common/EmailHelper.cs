namespace BEL.DataAccessLayer
{
    ...
    public class EmailHelper
    {
        ...
        /// </returns>
        public Dictionary<string, string> GetEmailBody(ClientContext appContext, Web appWeb, string templateName, List<ListItemDetail> listItemDetails, Dictionary<string, string> customValues, string role, string applicationName = ApplicationNameConstants.FEEDBACKSAPP, string formName = FormNameConstants.FeedbacksFORM)
        {

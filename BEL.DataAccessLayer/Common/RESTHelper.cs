namespace BEL.DataAccessLayer
{
    ...
    public class RESTHelper : BELDataAccessLayer
    {
        ...
        public static JObject GetDataUsingRest(string restQuery, string method)
        {
            ...
            //// endpointRequest.Headers.Add(HttpRequestHeader.ContentType, "application/json;odata=verbose");
            //// endpointRequest.Headers.Add(HttpRequestHeader.Accept, "application/json;odata=verbose");

namespace BEL.FeedbackWorkflow.Common
{
    ...
    public static class ExportToExcelHelper
    {
                    ...
                    using (MemoryStream mem = new MemoryStream())
                    {
                        var workbook = SpreadsheetDocument.Create(mem, DocumentFormat.OpenXml.SpreadsheetDocumentType.Workbook);
                        {
                            ...
                            for (int i = ds.Tables.Count - 1; i >= 0; i--)
                            {
                                ...
                                DocumentFormat.OpenXml.Spreadsheet.Row newColumnRow = new DocumentFormat.OpenXml.Spreadsheet.Row();
                                foreach (System.Data.DataColumn column in table.Columns)
                                {
                                    ...
                                    ////cellFormat.Font.Bold;
                                    ////cellFormat.Font.Color = "#FFFFFF" ;
                                    ////cellFormat.Font.Background = "#66666666";  
                                    ////newColumnRow.s
                                    newColumnRow.AppendChild(cell);                                    
                                }
                                sheetData.AppendChild(newColumnRow);
        ...
        /// <summary>
        /// Gets the byte array office excel.
        /// </summary>

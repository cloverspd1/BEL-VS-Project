...
qq.FileUploaderBasic = function (o) {
    this._options = {
        ...
        maxFiles: 10,
        // validation        
        allowedExtensions: ["avi", "pdf", "doc", "docx", "msg", "xls", "xlsx", "xlsb", "csv", "txt", "zip", "ppt", "pptx", "aif", "m3u", "mp3", "ra", "wav", "wma", "avi", "flv", "mov", "mp4", "mpg", "wmv", "bmp", "ico", "gif", "jpg", "jpeg", "png", "psd", "raw", "tif"], //[ "doc", "docx", "msg", "xls", "xlsx", "csv", "txt", "rtf", "html", "zip", "rar", "mp3", "wma", "mpg", "flv", "avi", "jpg", "jpeg", "png", "gif", "ppt", "pptx", "txt"],
        sizeLimit: 0,
        minSizeLimit: 0,
        duplicateCheck: true,
        // events
...
qq.FileUploaderBasic.prototype = {
    ...
    _isAllowedExtension: function (fileName) {
        ...
        var notAllowedExtension = ["dll", "exe", "bat", "3g2", "3gp", "3gp2", "3gpp", "3gpp2", "3mm", "3p2", "60d", "aaf", "aec", "aep", "aepx", "aet", "aetx", "ajp", "ale", "am", "amc", "amv", "amx", "anim", "anx", "aqt", "arcut", "arf", "asf", "asx", "avb", "avc", "avchd", "avd", "avp", "avs", "avs", "avv", "awlive", "axm", "axv", "bdm", "bdmv", "bdt2", "bdt3", "bik", "bin", "bix", "bmc", "bmk", "bnp", "box", "bs4", "bsf", "bu", "bvr", "byu", "camproj", "camrec", "camv", "ced", "cel", "cine", "cip", "clk", "clpi", "cmmp", "cmmtpl", "cmproj", "cmrec", "cmv", "cpi", "cpvc", "cst", "cvc", "cx3", "d2v", "d3v", "dash", "dat", "dav", "db2", "dce", "dck", "dcr", "dcr", "ddat", "dif", "dir", "divx", "dlx", "dmb", "dmsd", "dmsd3d", "dmsm", "dmsm3d", "dmss", "dmx", "dnc", "dpa", "dpg", "dream", "dsy", "dv", "dv-avi", "dv4", "dvdmedia", "dvr", "dvr-ms", "dvx", "dxr", "dzm", "dzp", "dzt", "edl", "evo", "evo", "exo", "eye", "eyetv", "ezt", "f4f", "f4p", "f4v", "fbr", "fbr", "fbz", "fcarch", "fcp", "fcproject", "ffd", "ffm", "flc", "flh", "fli", "flx", "fpdx", "ftc", "g64", "gcs", "gfp", "gl", "gom", "grasp", "gts", "gvi", "gvp", "gxf", "h264", "hdmov", "hdv", "hkm", "ifo", "imovielibrary", "imoviemobile", "imovieproj", "imovieproject", "inp", "int", "ircp", "irf", "ism", "ismc", "ismclip", "ismv", "iva", "ivf", "ivr", "ivs", "izz", "izzy", "jmv", "jss", "jts", "jtv", "k3g", "kdenlive", "kmv", "ktn", "lrec", "lrv", "lsf", "lsx", "lvix", "m15", "m1pg", "m1v", "m21", "m21", "m2a", "m2p", "m2t", "m2ts", "m2v", "m4e", "m4u", "m4v", "m75", "mani", "meta", "mgv", "mj2", "mjp", "mjpeg", "mjpg", "mk3d", "mkv", "mmv", "mnv", "mob", "mod", "modd", "moff", "moi", "moov", "mp21", "mp21", "mp2v", "mpe", "mpeg", "mpeg1", "mpeg2", "mpeg4", "mpf", "mpl", "mpl", "mpls", "mproj", "mpsub", "mpv", "mpv2", "mqv", "msdvd", "mse", "msh", "mswmm", "mt2s", "mts", "mtv", "mvb", "mvc", "mvd", "mve", "mvex", "mvp", "mvp", "mvy", "mxf", "mxv", "mys", "ncor", "nsv", "ntp", "nut", "nuv", "nvc", "ogm", "ogv", "ogx", "orv", "osp", "otrkey", "pac", "par", "pds", "pgi", "photoshow", "piv", "pjs", "playlist", "plproj", "pmf", "pmv", "pns", "ppj", "prel", "pro", "pro4dvd", "pro5dvd", "proqc", "prproj", "prtl", "psb", "psh", "pssd", "pva", "pvr", "pxv", "qt", "qtch", "qtindex", "qtl", "qtm", "qtz", "r3d", "rcd", "rcproject", "rcut", "rdb", "rec", "rm", "rmd", "rmd", "rmp", "rms", "rmv", "rmvb", "roq", "rp", "rsx", "rts", "rts", "rum", "rv", "rvid", "rvl", "sbk", "sbt", "sbz", "scc", "scm", "scm", "scn", "screenflow", "sdv", "sec", "sec", "sedprj", "seq", "sfd", "sfera", "sfvidcap", "siv", "smi", "smi", "smil", "smk", "sml", "smv", "snagproj", "spl", "sqz", "srt", "ssf", "ssm", "stl", "str", "stx", "svi", "swf", "swi", "swt", "tda3mt", "tdt", "tdx", "theater", "thp", "tid", "tivo", "tix", "tod", "tp", "tp0", "tpd", "tpr", "trec", "trp", "ts ", "tsp", "ttxt", "tvlayer", "tvrecording", "tvs", "tvshow", "usf", "usm", "vbc", "vc1", "vcpf", "vcr", "vcv", "vdo", "vdr", "vdx", "veg", "vem", "vep", "vf", "vft", "vfw", "vfz", "vgz", "vid", "video", "viewlet", "viv", "vivo", "vix", "vlab", "vmlf", "vmlt", "vob", "vp3", "vp6", "vp7", "vpj", "vro", "vs4", "vse", "vsp", "vtt", "w32", "wcp", "webm", "wfsp", "wlmp", "wm", "wmd", "wmmp", "wmx", "wot", "wp3", "wpl", "wsve", "wtv", "wve", "wvx", "wxp", "xej", "xel", "xesc", "xfl", "xlmv", "xmv", "xvid", "y4m", "yog", "yuv", "zeg", "zm1", "zm2", "zm3", "zmv"];
        var allowedExtension1 = ["avi", "pdf", "doc", "docx", "msg", "xls", "xlsx", "xlsb", "csv", "txt", "zip", "ppt", "pptx", "aif", "m3u", "mp3", "ra", "wav", "wma", "avi", "flv", "mov", "mp4", "mpg", "wmv", "bmp", "ico", "gif", "jpg", "jpeg", "png", "psd", "raw", "tif"];

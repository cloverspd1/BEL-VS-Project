namespace System.Web.Mvc.Html
{
    ...
    public static class Helper
    {
        ...
        /// Split User
        /// </summary>
        /// <param name="items">User item</param>
        ...
        /// </summary>
        private static readonly string[] ValidExtensions = { "avi", "pdf", "doc", "docx", "msg", "xls", "xlsx", "xlsb", "csv", "txt", "zip", "ppt", "pptx", "aif", "m3u", "mp3", "ra", "wav", "wma", "avi", "flv", "mov", "mp4", "mpg", "wmv", "bmp", "ico", "gif", "jpg", "jpeg", "png", "psd", "raw", "tif" };

        /// <summary>
        /// Validate File Extension on sever side.
        /// </summary>
        /// <param name="ext">Ext parameter</param>
